...
class TestMain(unittest.TestCase):
    ...
    def test_load_and_preprocess(self):
        ...
        self.assertIn("beer", columns, "Column renaming failed for 'beer'")
        self.assertIn("spirits", columns, "Column renaming failed for 'spirits'")
        self.assertIn("wine", columns, "Column renaming failed for 'wine'")
        self.assertIn(
            "total_alcohol", columns, "Column renaming failed for 'total_alcohol'"
        )
    ...
    def test_calculate_basic_stats(self):
        ...
        self.assertIn(
            "summary", stats.columns, "Statistics should include a summary column"
        )
